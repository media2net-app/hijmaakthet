...
export const useAnimatedProgress = (target: number, duration: number = 2000) => {
  ...
  useEffect(() => {
    ...
    const animate = (currentTime: number) => {
      ...
      // Easing function for smooth animation
      const easeOutQuart = 1 - Math.pow(1 - timeProgress, 4);
      const currentProgress = target * easeOutQuart;
